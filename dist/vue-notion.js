...
const V = /* @__PURE__ */ h(Xe, [["render", Ye]]), A = 46, Ze = {
  name: "NotionColumn",
  props: ["format"],
  computed: {
    columnStyle() {
      return {
        width: `calc((100% - ${(Number((1 / this.format.column_ratio).toFixed(0)) - 1) * A}px) * ${this.format.column_ratio})`
      };
    },
    spacerStyle() {
      return { width: `${A}px` };
...
const Q = /* @__PURE__ */ h(mt, [["render", _t]]), gt = {
  ...
  computed: {
    ...
    start() {
      var e;
      return q((e = this.value) == null ? void 0 : e.id, this.blockMap);
    }
  }
}, yt = {
  key: 0,
...
function yo(e, t, s, l, p, o) {
  ...
  return e.blockOverrides.hasOwnProperty(e.type) ? (n(), d(P(e.blockOverrides[e.type]), f(a({ key: 0 }, e.pass)), null, 16)) : e.isType("page") ? (n(), r("div", ho, [
    ...
    _: 3
  }, 16)) : e.isType("code") ? (n(), d(w, f(a({ key: 5 }, e.pass)), null, 16)) : e.isType("equation") ? (n(), d(se, f(a({ key: 6 }, e.pass)), null, 16)) : e.isType("text") ? (n(), d(ae, f(a({ key: 7 }, e.pass)), null, 16)) : e.isType("quote") ? (n(), d(re, f(a({ key: 8 }, e.pass)), null, 16)) : e.isType("to_do") ? (n(), d(ie, f(a({ key: 9 }, e.pass)), null, 16)) : e.isType("toggle") ? (n(), d(le, f(a({ key: 10 }, e.pass)), {
    default: b(() => [
      g(e.$slots, "default")
    ]),
    _: 3
...
const $o = /* @__PURE__ */ h(mo, [["render", yo]]), bo = {
  ...
  props: {
    ...
    hideList: { type: Array, default: () => [] },
    level: { type: Number, default: 0 },
    mapImageUrl: { type: Function, default: ge },
...
const Lo = /* @__PURE__ */ h(Po, [["render", Co]]), Ro = {
  ...
  NotionTodo: oe,
  NotionToggle: ne
}, Symbol.toStringTag, { value: "Module" })), Io = async (e, t = "https://api.vue-notion.workers.dev/v1") => await fetch(`${t}/table/${e}`).then((s) => s.json()), So = async (e, t = "https://api.vue-notion.workers.dev/v1") => await fetch(`${t}/page/${e}`).then((s) => s.json()), Bo = {
  install: (e) => {
...
export {
  ...
  W as NotionImage,
  G as NotionList,
  J as NotionNestedList,
  Y as NotionPage,
  X as NotionPageHeader,
  M as NotionPageIcon,
  Z as NotionQuote,
  vo as NotionRenderer,
  x as NotionTable,
  ee as NotionTableRow,
  te as NotionText,
